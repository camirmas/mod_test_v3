...
sim('../open_loop_test_ED.slx',[0,TMax]);

disp('Creating ED .mat files');
create_ED_mat_files('../report_data/5MW_OC4Semi_WSt_WavesWN_base/5MW_OC4Semi_WSt_WavesWN_FAST.SFunc.outb', '5MW_OC4Semi_WSt_WavesWN');
